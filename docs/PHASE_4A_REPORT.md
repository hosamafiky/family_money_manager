...
| `dashboard_balance_db_test.dart` _(Phase 4A)_      |      34 |
| `dashboard_period_db_test.dart` _(Phase 4A)_       |       7 |
...
| `dashboard_period_test.dart` _(Phase 4A)_  |       6 |
| `dashboard_summary_test.dart` _(Phase 4A)_ |       6 |
...
| `dashboard_screen_test.dart` _(Phase 4A)_ |     18 |
