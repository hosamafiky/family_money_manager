...
class ExpenseReviewScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final members = membersAsync.maybeWhen(data: (r) => r is AppOk<List<HouseholdMember>> ? r.value : <HouseholdMember>[], orElse: () => <HouseholdMember>[]);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          if (ctx.childWithdrawalAudit != null) _Row(l10n.fieldWithdrawalReason, ctx.childWithdrawalAudit!.reason),
  ...
  Future<void> _submit(BuildContext context, WidgetRef ref, AppLocalizations l10n, ExpenseContext ctx) async {
