...
final budgetsProvider = FutureProvider.family<AppResult<List<BudgetPlan>>, String>((ref, householdId) {
...
final budgetProgressProvider = FutureProvider.family<AppResult<BudgetProgress>, String>((ref, budgetId) {
...
final budgetHistoryProvider = FutureProvider.family<AppResult<List<BudgetProgress>>, String>((ref, budgetId) {
